...
import {addAuditDetailsApi} from '../redux/actions/audit.action';
import moment from 'moment';

import {getAllUsersApi} from '../redux/actions/users.action';
import {addObjectifApi} from '../redux/actions/objectif.actions';
const AddObjectifModal = ({showModal, closeModal, id_audit}) => {
  useEffect(() => {
...
export default AddObjectifModal;
